...
{
	public IEnumerator Shake(float duration, float magnitude, float decreaseAmount)
	{
		...
		{
			Vector3 randomXY = Random.insideUnitSphere * magnitude;
			
			//transform.localPosition = new Vector3(randomXY.x, randomXY.y, originalPos.z);
			transform.localPosition += randomXY;
			
			elapsed += Time.deltaTime;
			magnitude -= decreaseAmount;
